...
final class AdminCommentController extends AbstractController{
    ...
    public function show(Comment $comment): Response
    {
        return $this->render('admin_comment/show.html.twig', [
            'comment' => $comment,
            'title' => "Commentaire De " . $comment->getUser()->getUsername(),
        ]);
    }

    #[Route('/{id}/edit/published', name: 'app_admin_comment_edit_published', methods: ['POST'])]
    public function editPublished(Request $request, Comment $comment, EntityManagerInterface $entityManager): JsonResponse
    {
        ...
        $comment->setCommentPublished($boolean);
        $entityManager->flush();
